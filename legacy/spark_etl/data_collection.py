...
Usage:
    ...
    python data_collection.py --collectors all
    python data_collection.py --collectors idealista density
    
    # Reset and reload all data (delete Bronze layer and tracking logs)
    python data_collection.py --reset
    python data_collection.py --collectors idealista --reset
"""
