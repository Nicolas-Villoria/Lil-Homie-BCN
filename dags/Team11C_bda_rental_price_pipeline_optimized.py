"""
Team11C_bda_rental_price_pipeline_optimized.py
---------------------------------------
...
def collect_idealista_data(**context):
    ...
    from Team11C_data_collection import run_collectors
...
def run_data_formatting(**context):
    ...
    """
    from Team11C_data_formatting import run_formatting
...
def run_exploitation_zone(**context):
    ...
    from Team11C_exploitation_zone import create_exploitation_zone
...
def train_linear_regression(**context):
    ...
    from Team11C_ml_training_parallel import train_single_model
...
def select_and_register_best_model(**context):
    ...
    """
    from Team11C_ml_training_parallel import select_best_model
